...
abstract class $LocationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool serviceEnabled, LocationPermission permission});
}
...
class _$LocationStateImpl implements _LocationState {
  ...
  @override
  String toString() {
    return 'LocationState(serviceEnabled: $serviceEnabled, permission: $permission)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, serviceEnabled, permission);
...
abstract class _LocationState implements LocationState {
  const factory _LocationState(
      {final bool serviceEnabled,
      final LocationPermission permission}) = _$LocationStateImpl;
