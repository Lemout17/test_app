...
class AppTheme {
  static ThemeData lightTheme = _generateTheme(
    const ColorScheme(
      onPrimary: Color.fromARGB(255, 198, 142, 142),
  ...
  static ThemeData darkTheme = _generateTheme(
    const ColorScheme(
  ...
  static ThemeData _generateTheme(ColorScheme colorScheme) {
